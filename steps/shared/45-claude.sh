...
# this repo, the same call as p10k and the zsh plugins. They are ~23 MB and
# entirely optional: say no to this step, or `rm -rf` them afterwards.
#
# What IS tracked is ~/.claude/settings.json, plus the statusline script it
# calls, both symlinked by step 10.
